...
import { PersonSchoolcoreDialogComponent } from '../../../../../../main/webapp/app/entities/person-schoolcore/person-schoolcore-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('PersonSchoolcore Management Dialog Component', () => {
        let comp: PersonSchoolcoreDialogComponent;
        let fixture: ComponentFixture<PersonSchoolcoreDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PersonSchoolcoreDialogComponent],
                providers: [
                    PersonSchoolcoreService
                ]
            })
            .overrideTemplate(PersonSchoolcoreDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(PersonSchoolcoreDialogComponent);
