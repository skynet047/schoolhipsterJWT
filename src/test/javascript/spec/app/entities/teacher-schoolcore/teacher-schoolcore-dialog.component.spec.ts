...
import { TeacherSchoolcoreDialogComponent } from '../../../../../../main/webapp/app/entities/teacher-schoolcore/teacher-schoolcore-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('TeacherSchoolcore Management Dialog Component', () => {
        let comp: TeacherSchoolcoreDialogComponent;
        let fixture: ComponentFixture<TeacherSchoolcoreDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TeacherSchoolcoreDialogComponent],
                providers: [
                    SubjectSchoolcoreService,
                    TeacherSchoolcoreService
                ]
            })
            .overrideTemplate(TeacherSchoolcoreDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(TeacherSchoolcoreDialogComponent);
