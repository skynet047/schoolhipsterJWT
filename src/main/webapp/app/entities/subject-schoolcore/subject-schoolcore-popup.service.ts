...
@Injectable()
export class SubjectSchoolcorePopupService {
            ...
            if (id) {
                this.subjectService.find(id)
                    .subscribe((subjectResponse: HttpResponse<SubjectSchoolcore>) => {
                        const subject: SubjectSchoolcore = subjectResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.subjectModalRef(component, new SubjectSchoolcore());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    subjectModalRef(component: Component, subject: SubjectSchoolcore): NgbModalRef {
