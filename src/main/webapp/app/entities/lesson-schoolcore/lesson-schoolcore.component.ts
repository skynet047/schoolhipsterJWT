...
currentAccount: any;
    ...
    loadAll() {
        this.lessonService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<LessonSchoolcore[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/lesson-schoolcore'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: LessonSchoolcore) {
        return item.id;
    }
